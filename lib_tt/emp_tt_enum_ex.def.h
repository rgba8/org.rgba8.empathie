//-----------------------------------------------------------------------------
// emp_tt_enum_ex.def.h - @rgba8.org
//-----------------------------------------------------------------------------
#ifndef enum_values
...
#define enum_value_ex_2(x_Name, x_User)          enum_forward(x_Name, EMP_PP_SOLVE(x_User))
#define enum_value_ex_3(x_Name, x_Value, x_User) enum_forward(x_Name, x_Value, EMP_PP_SOLVE(x_User))
#define enum_forward(...) enum_value_ex_impl(__VA_ARGS__)
        enum_values
#undef enum_value_1
#undef enum_value_2
